...
const ExportCSV = ( ) => {
  const headers = [
    ...
    { label: 'Student Class', key: 'studentClass' },
    { label: 'Student ID', key: 'studentID' },
    { label: 'Student Contact', key: 'studentContact' }
  ];
  return (
    <CSVLink data={students} headers={headers} filename={"students.csv"} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Export CSV</CSVLink>
  )
}
